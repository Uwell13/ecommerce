    ...
    <div class="modal-header">
      ...
      <div class="modal-body">
              ...
              <ul class="nav nav-pills">
                  <li class="active"><a class="btn btn-default check_out" href="#home" data-toggle="tab">Masuk</a>
                  </li>
                  <li><a class="btn btn-default check_out" href="#profile" data-toggle="tab">Buat akun</a>
                  </li>
                                     ...
                                     <div class="panel-body">
                                        ...
                                        <div class="col-md-10">
                                          ...
                                          <div class="col-md-8">
                                            <input  id="GENDER" name="GENDER" placeholder=
                                                ...
                                                <input   id="GENDER" name="GENDER" placeholder=
                                                "Gender" type="radio" value="Female"> <b> Prempuan </b>
                                          </div>
                                        </div>
                                      </div>
                                      ...
                                      <div class="form-group">
                                        <div class="col-md-10">
                                          ...
                                          <div class="col-md-8">
                                          <p>Note</p>
                                          Kata sandi harus minimal 8 hingga 15 karakter.
                                         </div> 
                                        </div>
                                      </div> 
                                      ...
                                      <div class="form-group">
                                       ...
                                       <div class="form-group">
                                        <div class="col-md-10">
                                          ...
                                          "image"></label>
                                          <div class="col-md-8">
                                        <p>  Saya <input type="checkbox" id="conditionterms" name="conditionterms" value="checkbox" />
                                           <small>Setuju dengan <a class="toggle-modal"  onclick=" OpenPopupCenter('terms.php','Terms And Codition','600','600')"  ><b>Syarat dan ketentuan</b></a> Aplikasi Tokopekita</small>
