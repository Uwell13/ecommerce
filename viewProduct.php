     ...
     <div class="modal-body">  
              <div class="row">  
                ...
                <div class="col-md-6">
                    ...
                    <button class="btn btn-pup"  name="btnorder" type="Submit">Order Sekarang!</button> 
                    <button class="btn btn-default" id="btn_close" data-dismiss="modal" type="button">Tutup</button> 
